...
Present in markdown using this heading hierarchy:
  - Use ## (h2) for major top-level sections only (e.g. Key News, Macro, Geopolitics, Sectors, Positioning Summary, Upcoming Catalysts)
...
Open with a 'Key News' section consolidating the day's important items as tight bullets.
